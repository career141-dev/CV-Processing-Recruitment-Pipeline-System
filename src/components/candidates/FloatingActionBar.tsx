...
export function FloatingActionBar({ selectedCount, onClear }: FloatingActionBarProps) {
  ...
  return (
    <div className="fixed bottom-[40px] right-6 flex items-center bg-[#212121] py-3 px-6 rounded-xl shadow-2xl z-50">
      ...
      <button className="flex items-center bg-[#FFFFFF1A] hover:bg-[#FFFFFF33] transition-colors py-1.5 px-3 mr-3 gap-2 rounded-lg border-0 cursor-pointer text-white">
        <img
      ...
      <button className="flex items-center bg-[#FFFFFF1A] hover:bg-[#FFFFFF33] transition-colors py-1.5 px-3 mr-4 gap-2 rounded-lg border-0 cursor-pointer text-white">
        <img
