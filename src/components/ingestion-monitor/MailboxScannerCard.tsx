    ...
    <div className="bg-surface-container-lowest dark:bg-surface-container-low border border-border rounded-xl shadow-sm p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-2 space-y-2">
          ...
          >
            <option value={50}>Top 50 Messages</option>
            <option value={150}>Top 150 Messages</option>
            <option value={300}>Top 300 Messages</option>
            <option value={500}>Top 500 Messages</option>
          </select>
        </div>
        ...
        <div className="bg-surface-container-low dark:bg-surface-container border border-border rounded-xl p-5 space-y-5">
            ...
            {latestJob.status === "running" && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1 text-xs font-semibold rounded bg-amber-500/10 text-amber-600 hover:bg-amber-500/20 border border-amber-500/20 flex items-center gap-1"
                >
                  <Pause className="w-3 h-3" /> Pause
                </button>
                <button
                  onClick={() => handleControlAction("stop")}
                  className="px-2.5 py-1 text-xs font-semibold rounded bg-red-500/10 text-red-600 hover:bg-red-500/20 border border-red-500/20 flex items-center gap-1"
                >
            ...
            {latestJob.status === "paused" && (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2.5 py-1 text-xs font-semibold rounded bg-emerald-500/10 text-emerald-600 hover:bg-emerald-500/20 border border-emerald-500/20 flex items-center gap-1"
                >
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between text-xs font-semibold text-text-secondary">
              <span>
                Scanned: {latestJob.scannedMessages} messages ({latestJob.totalAttachments} attachments)
              </span>
